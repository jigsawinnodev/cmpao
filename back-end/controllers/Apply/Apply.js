...
const ManageInsertAndEdit = (req, res) => {
    ...
    const { jc_type, jc_start, jc_end, job_position, job_amount, job_payment, job_no, job_detail_payment, job_id, jc_id, type_file, tree } = req.body;
