                  ...
                  <div className="col-md-12">
                    <div className="">
                      ...
                      <p className="m-0 text-md-start text-center">
                        {"ที่อยู่ " +
                          dataVertify.m_house_no +
                          "/" +
                          dataVertify.m_moo}
                        {" ตำบล" + " " + dataVertify.subdistrict_th}
                        {" อำเภอ" + " " + dataVertify.district_th}
                        {" จังหวัด" + " " + dataVertify.province_th}
                      </p>
                    </div>
                  </div>
                  <div className="col-md-12">
                    <div className="py-4 text-center">
                      <div className="d-flex justify-content-center flex-column flex-md-column ">
                        <NavLink to={"Edit_profile/" + dataVertify.m_id}>
